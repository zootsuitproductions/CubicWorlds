...
//
//public class CopyBlocksOverTime implements ISetBlocksOverTimeOperation {
...
//  int currentZ;
//
//  CopyBlocksOverTime(Location centerToCopy, int radius, int blocksPerTick, Plugin plugin, ISetBlocksOverTimeOperation nextOp) {
...
//
//
//  //add each block to a list, containing the vector relative location, biome data. need to save to a file. then iterate through the list
//  // to paste
